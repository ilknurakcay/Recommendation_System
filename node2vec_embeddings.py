...
#If you want to run train model, you can use folowing 4  lines.
...
def get_position_name(job_id, item_info):
    ...
    Parameters:
    - job_id: The job's ID, e.g., 'J_4031363'.
    - item_info: A pandas DataFrame containing job information.
...
def calculate_average_similarity(job_embeddings, G_subgraph, item_info, num_pairs=5):
    ...
    # Generate all job pairs and randomly select 5
